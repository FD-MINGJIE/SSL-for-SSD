...
if torch.cuda.is_available():
    ...
    if not args.cuda:
        ...
        torch.set_default_tensor_type('torch.FloatTensor')  #cpu
else:
...
def train():
    ...
    for iteration in range(args.start_iter, cfg['max_iter'] + 20000):
        ...
        if iteration != 0 and (iteration+1) % 10000 == 0:
            ...
            torch.save(ssd_net.state_dict(), 'weights/ssd300_COCO_SSD_' +
                       repr(iteration) + '.pth')
